...
(function () {
  ...
  function DCOffset(value) {
    if ( 'undefined' === typeof value ) {
      value = 1;
    }
    var gain = __ctx.createGain();
    gain.gain.value = value;
    offsetProvider.connect(gain);
    gain.offset = gain.gain; // Add Alias
    return gain;
  }
  ...
  WamlModule.prototype.createAudioParamBridge = function(defaultValue, dest, callback) {
    var ctx = this.ctx;
    var offset = DCOffset(defaultValue);
    var param = offset.gain;
