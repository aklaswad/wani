...
(function () {
  ...
  function WamlOscillator (ctx) {

  }
  WamlOscillator.prototype = Object.create(WamlModule.prototype);

  WamlOscillator.prototype.noteOn = function (noteNumber) {
    throw('Virtual method "WamlOscillator.noteOn" has called');
  };

  WamlOscillator.prototype.noteOff = function (noteNumber) {
    throw('Virtual method "WamlOscillator.noteOff" has called');
  };
